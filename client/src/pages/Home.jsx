        ...
        <div className="flex flex-col min-h-screen ">
            ...
            <div className="relative bg-black text-white rounded-3xl overflow-hidden mb-12 shadow-2xl">
                ...
                <div className="relative p-10 md:p-20 text-center flex flex-col items-center z-10">
                    ...
                    <div className="w-full max-w-2xl mx-auto relative flex items-center shadow-2xl group">
                        <FaSearch className="absolute left-6 top-1/2 -translate-y-1/2 text-gray-500 text-xl z-10 group-focus-within:text-gray-600 transition-colors" />
                        <input
                            type="text"
                            placeholder="Search events by title..."
                            className="w-full pl-16 pr-6 py-4 rounded-full text-lg text-black bg-white/95 backdrop-blur-sm border-2 border-transparent focus:border-gray-500 focus:outline-none transition-all placeholder-gray-400 font-medium"
                            value={search}
            ...
            <footer className="mt-auto pt-16 pb-8 border-t border-gray-200 text-center">
                <div className="flex justify-center items-center gap-2 mb-4">
                    ...
                    <span className="text-transparent font-serif bg-clip-text bg-linear-to-r from-gray-950 to-gray-500">Eventora</span>
                </div>
                <p className="text-gray-500 text-sm mb-6 max-w-md mx-auto">
                    The simplest, most dynamic way to manage, discover, and host world-class events in your local city with <span className="text-transparent font-serif bg-clip-text bg-linear-to-r from-cyan-950 to-gray-500">Saurav</span>. Let's make memories together.
                </p>
                <div className="text-xs text-gray-400 font-medium uppercase tracking-wider">
                    &copy; {new Date().getFullYear()} S'Eventora Platform. All rights reserved.
                </div>
